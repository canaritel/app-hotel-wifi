package es.canaritel.views.gridwithfilters;
...
import es.canaritel.data.SamplePerson;
import es.canaritel.services.SamplePersonService;
import es.canaritel.views.MainLayout;
