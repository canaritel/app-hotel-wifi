...
import es.canaritel.data.User;
import es.canaritel.security.AuthenticatedUser;
import es.canaritel.views.addressform.AddressFormView;
import es.canaritel.views.empty.EmptyView;
import es.canaritel.views.feed.FeedView;
import es.canaritel.views.gridwithfilters.GridwithFiltersView;
...
public class MainLayout extends AppLayout {
    ...
    private void addDrawerContent() {
        Span appName = new Span("Hotel-WiFi-Marketing");
